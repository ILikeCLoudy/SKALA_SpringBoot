...
import com.SKALA.LikeCloudy.Domain.Region;
import com.SKALA.LikeCloudy.Domain.User;
import com.SKALA.LikeCloudy.Repository.RegionRepository;
...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // 사용자 데이터 생성
        userRepository.save(new User("Karina", "Karina@sm.co.kr", seoul));
        userRepository.save(new User("Winter", "Winter@sm.co.kr", busan));
